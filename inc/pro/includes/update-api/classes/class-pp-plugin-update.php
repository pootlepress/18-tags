...
class Pootle_Update_Manager_Update_Check {
	...
	public function update_check( $transient ) {
		...
		sfp_api_check_response_for_errors( $response, $this );
	...
	public function expired_license_error_notice( $message ){
		...
		echo sprintf( '<div id="message" class="error"><p>' . __( 'The license key for %s has expired. You can reactivate or purchase a license key by logging in to your account at <a href="%s" target="_blank">%s</a>.', $this->text_domain ) . '</p></div>', $this->product_id, $this->renew_license_url, str_replace( array('http', ':', '/'), '', $this->renew_license_url ) ) ;
	...
	public function on_hold_subscription_error_notice( $message ){
		...
		echo sprintf( '<div id="message" class="error"><p>' . __( 'The subscription for %s is on-hold. You can reactivate the subscription by logging in to your account at <a href="%s" target="_blank">%s</a>.', $this->text_domain ) . '</p></div>', $this->product_id, $this->renew_license_url, str_replace( array('http', ':', '/'), '', $this->renew_license_url ) ) ;
	...
	public function cancelled_subscription_error_notice( $message ){
		...
		echo sprintf( '<div id="message" class="error"><p>' . __( 'The subscription for %s has been cancelled. You can renew the subscription by logging in to your account at <a href="%s" target="_blank">%s</a>. A new license key will be emailed to you after your order has been completed.', $this->text_domain ) . '</p></div>', $this->product_id, $this->renew_license_url, str_replace( array('http', ':', '/'), '', $this->renew_license_url ) ) ;
	...
	public function expired_subscription_error_notice( $message ){
		...
		echo sprintf( '<div id="message" class="error"><p>' . __( 'The subscription for %s has expired. You can reactivate the subscription by logging in to your account at <a href="%s" target="_blank">%s</a>.', $this->text_domain ) . '</p></div>', $this->product_id, $this->renew_license_url, str_replace( array('http', ':', '/'), '', $this->renew_license_url ) ) ;
	...
	public function suspended_subscription_error_notice( $message ){
		...
		echo sprintf( '<div id="message" class="error"><p>' . __( 'The subscription for %s has been suspended. You can reactivate the subscription by logging in to your account at <a href="%s" target="_blank">%s</a>.', $this->text_domain ) . '</p></div>', $this->product_id, $this->renew_license_url, str_replace( array('http', ':', '/'), '', $this->renew_license_url ) ) ;
	...
	public function pending_subscription_error_notice( $message ){
		...
		echo sprintf( '<div id="message" class="error"><p>' . __( 'The subscription for %s is still pending. You can check on the status of the subscription by logging in to your account at <a href="%s" target="_blank">%s</a>.', $this->text_domain ) . '</p></div>', $this->product_id, $this->renew_license_url, str_replace( array('http', ':', '/'), '', $this->renew_license_url ) ) ;
	...
	public function trash_subscription_error_notice( $message ){
		...
		echo sprintf( '<div id="message" class="error"><p>' . __( 'The subscription for %s has been placed in the trash and will be deleted soon. You can purchase a new subscription by logging in to your account at <a href="%s" target="_blank">%s</a>.', $this->text_domain ) . '</p></div>', $this->product_id, $this->renew_license_url, str_replace( array( 'http', ':', '/' ), '', $this->renew_license_url ) ) ;
	...
	public function no_subscription_error_notice( $message ){
		...
		echo sprintf( '<div id="message" class="error"><p>' . __( 'A subscription for %s could not be found. You can purchase a subscription by logging in to your account at <a href="%s" target="_blank">%s</a>.', $this->text_domain ) . '</p></div>', $this->product_id, $this->renew_license_url, str_replace( array('http', ':', '/'), '', $this->renew_license_url ) ) ;
	...
	public function no_key_error_notice( $message ){
		...
		echo sprintf( '<div id="message" class="error"><p>' . __( 'A license key for %s could not be found. Maybe you forgot to enter a license key when setting up %s, or the key was deactivated in your account. You can reactivate or purchase a license key by logging in to your account at <a href="%s" target="_blank">%s</a>.', $this->text_domain ) . '</p></div>', $this->product_id, $this->product_id, $this->renew_license_url, str_replace( array('http', ':', '/'), '', $this->renew_license_url ) ) ;
	...
	public function download_revoked_error_notice( $message ){
		...
		echo sprintf( '<div id="message" class="error"><p>' . __( 'Download permission for %s has been revoked possibly due to a license key or subscription expiring. You can reactivate or purchase a license key by logging in to your account at <a href="%s" target="_blank">%s</a>.', $this->text_domain ) . '</p></div>', $this->product_id, $this->renew_license_url, str_replace( array('http', ':', '/'), '', $this->renew_license_url ) ) ;

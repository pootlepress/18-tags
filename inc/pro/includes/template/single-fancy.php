...
if ( ! pootlepb_is_panel() ) {
	...
	<header class="entry-header">
		<?php if ( has_post_thumbnail( get_the_ID() ) ) {
			...
			<div id="kickass-feat" class="etp-full-width-image-bg"
			     data-top-bottom="background-position: center 160px;"
			     data-top-top="background-position: center 0px;"
			     style="background-image: url('<?php echo $image[0]; ?>')">
				<div class="col-full">
					<h1 data-bottom="opacity:1; padding-bottom: 20%;"
					    data--100-center="opacity:1; padding-bottom: 10%;"
					    data-top-bottom="opacity:0.16; padding-bottom: 0%;" class="entry-title"
